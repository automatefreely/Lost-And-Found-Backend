...
class Found(models.Model):
    ...
    description=models.CharField("Short description of found item",max_length=300, default=None, blank=True, null=True)
    created=models.DateTimeField("Post Created At",auto_now_add=True)
    location=models.CharField("location where item was found",max_length=100, default=None, blank=True, null=True)
    foundDate=models.DateTimeField("Date when item was lost", default=None, blank=True, null=True)
    contactEmail=models.EmailField("Email of finder",max_length=50, default=None, blank=True, null=True)
