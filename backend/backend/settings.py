...
SECRET_KEY = os.environ.get(
    'SECRET', "django-insecure-%1g(j+i1)vwc)0br-pb1cs#rk+!51n7_4b@5-nct3i0eu%r8am")
...
MIDDLEWARE = [
    ...
    'helpers.middlewares.BasicMiddleware'
]
...
MEDIA_ROOT = os.path.join(BASE_DIR, "filestore"),  # your media/ files folder
